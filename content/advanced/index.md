...
>>> [institutional-trading.md](./institutional-trading.md) >>>
...
>>> [smart-money-concepts.md](./smart-money-concepts.md) >>> (most popular)

>>> [order-flow.md](./order-flow.md) >>> (highest edge)

>>> [algorithmic-trading.md](./algorithmic-trading.md) >>> (for automation)
